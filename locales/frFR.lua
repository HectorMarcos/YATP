...
if not L["Show Ammo (Hunter only)"] then L["Show Ammo (Hunter only)"] = "Afficher Munitions (Chasseur seulement)" end
if not L["Show Ammo"] then L["Show Ammo"] = "Afficher Munitions" end
if not L["Low Ammo Threshold"] then L["Low Ammo Threshold"] = "Seuil de Munitions Faibles" end
if not L["Color ammo below threshold"] then L["Color ammo below threshold"] = "Colorer les munitions sous le seuil" end
if not L["Show Soul Shards (Warlock only)"] then L["Show Soul Shards (Warlock only)"] = "Afficher Éclats d'Âme (Démoniste seulement)" end
if not L["Show Soul Shards"] then L["Show Soul Shards"] = "Afficher Éclats d'Âme" end
if not L["Hunter"] then L["Hunter"] = "Chasseur" end
if not L["Warlock"] then L["Warlock"] = "Démoniste" end
if not L["Low Shards Threshold"] then L["Low Shards Threshold"] = "Seuil d'Éclats Faibles" end
if not L["Color shards below threshold"] then L["Color shards below threshold"] = "Colorer les éclats sous le seuil" end
